...
class EmployeeResourceIT {
    ...
    private static final Double DEFAULT_RMO_HOURLY_RATE = 1D;
    private static final Double UPDATED_RMO_HOURLY_RATE = 2D;

    private static final EmployeeType DEFAULT_TYPE = EmployeeType.Doctor;
    private static final EmployeeType UPDATED_TYPE = EmployeeType.Nurse;
    ...
    public static Employee createEntity() {
        return new Employee()
            ...
            .rmoHourlyRate(DEFAULT_RMO_HOURLY_RATE)
            .type(DEFAULT_TYPE)
    ...
    public static Employee createUpdatedEntity() {
        return new Employee()
            ...
            .rmoHourlyRate(UPDATED_RMO_HOURLY_RATE)
            .type(UPDATED_TYPE)
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].rmoHourlyRate").value(hasItem(DEFAULT_RMO_HOURLY_RATE)))
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.rmoHourlyRate").value(DEFAULT_RMO_HOURLY_RATE))
