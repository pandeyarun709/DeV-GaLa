...
import static com.farmer.be.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.phone(UPDATED_PHONE).createdBy(UPDATED_CREATED_BY).createdOn(UPDATED_CREATED_ON).updatedBy(UPDATED_UPDATED_BY);
