...
public interface AddressService {
    ...
    /**
     * Get all the AddressDTO where Hospital is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<AddressDTO> findAllWhereHospitalIsNull();
    /**
     * Get all the AddressDTO where Patient is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<AddressDTO> findAllWherePatientIsNull();
