...
public class AddressResource {
    ...
    public ResponseEntity<List<AddressDTO>> getAllAddresses(
        ...
        if ("hospital-is-null".equals(filter)) {
            LOG.debug("REST request to get all Addresss where hospital is null");
            return new ResponseEntity<>(addressService.findAllWhereHospitalIsNull(), HttpStatus.OK);
        }

        if ("patient-is-null".equals(filter)) {
            LOG.debug("REST request to get all Addresss where patient is null");
            return new ResponseEntity<>(addressService.findAllWherePatientIsNull(), HttpStatus.OK);
        }
