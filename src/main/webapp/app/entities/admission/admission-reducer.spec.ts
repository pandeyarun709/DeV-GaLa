...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './admission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADMISSION actions', async () => {
      const arg = { id: 13361 };
    ...
    it('dispatches UPDATE_ADMISSION actions', async () => {
      const arg = { id: 13361 };
    ...
    it('dispatches PARTIAL_UPDATE_ADMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADMISSION actions', async () => {
      const arg = 42666;
