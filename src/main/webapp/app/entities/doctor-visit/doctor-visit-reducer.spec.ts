...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORVISIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCTORVISIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCTORVISIT actions', async () => {
      const arg = { id: 26428 };
    ...
    it('dispatches UPDATE_DOCTORVISIT actions', async () => {
      const arg = { id: 26428 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORVISIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCTORVISIT actions', async () => {
      const arg = 42666;
