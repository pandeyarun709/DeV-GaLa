...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICINEBATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICINEBATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICINEBATCH actions', async () => {
      const arg = { id: 29449 };
    ...
    it('dispatches UPDATE_MEDICINEBATCH actions', async () => {
      const arg = { id: 29449 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICINEBATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICINEBATCH actions', async () => {
      const arg = 42666;
