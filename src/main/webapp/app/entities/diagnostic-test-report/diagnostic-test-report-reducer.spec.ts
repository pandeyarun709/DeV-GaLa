...
import reducer, {
  ...
  reset,
  updateEntity,
} from './diagnostic-test-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTICTESTREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIAGNOSTICTESTREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIAGNOSTICTESTREPORT actions', async () => {
      const arg = { id: 6392 };
    ...
    it('dispatches UPDATE_DIAGNOSTICTESTREPORT actions', async () => {
      const arg = { id: 6392 };
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTICTESTREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIAGNOSTICTESTREPORT actions', async () => {
      const arg = 42666;
