...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUALIFICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUALIFICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUALIFICATION actions', async () => {
      const arg = { id: 30420 };
    ...
    it('dispatches UPDATE_QUALIFICATION actions', async () => {
      const arg = { id: 30420 };
    ...
    it('dispatches PARTIAL_UPDATE_QUALIFICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUALIFICATION actions', async () => {
      const arg = 42666;
