...
import { deleteEntity, getEntity } from './hospital.reducer';
...
export const HospitalDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hospitalBeApp.hospital.delete.question">
        <Translate contentKey="hospitalBeApp.hospital.delete.question" interpolate={{ id: hospitalEntity.id }}>
