...
import reducer, {
  ...
  reset,
  updateEntity,
} from './doctor-visit-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORVISITTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCTORVISITTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCTORVISITTYPE actions', async () => {
      const arg = { id: 12377 };
    ...
    it('dispatches UPDATE_DOCTORVISITTYPE actions', async () => {
      const arg = { id: 12377 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORVISITTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCTORVISITTYPE actions', async () => {
      const arg = 42666;
