  ...
  return (
    <div>
      <h2 id="department-heading" data-cy="DepartmentHeading">
        <Translate contentKey="hospitalBeApp.department.home.title">Departments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hospitalBeApp.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/department/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hospitalBeApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </div>
      </h2>
          ...
          {departmentList && departmentList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="hospitalBeApp.department.id">ID</Translate>{' '}
                  ...
                  <th>
                    <Translate contentKey="hospitalBeApp.department.hospital">Hospital</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {departmentList.map((department, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {department.createdOn ? <TextFormat type="date" value={department.createdOn} format={APP_DATE_FORMAT} /> : null}
                    </td>
                    <td>{department.updatedBy}</td>
                    <td>
                      {department.updatedOn ? <TextFormat type="date" value={department.updatedOn} format={APP_DATE_FORMAT} /> : null}
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="hospitalBeApp.department.home.notFound">No Departments found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
