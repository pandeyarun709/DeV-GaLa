...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTICTEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIAGNOSTICTEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIAGNOSTICTEST actions', async () => {
      const arg = { id: 30773 };
    ...
    it('dispatches UPDATE_DIAGNOSTICTEST actions', async () => {
      const arg = { id: 30773 };
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTICTEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIAGNOSTICTEST actions', async () => {
      const arg = 42666;
