...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './medicine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICINE actions', async () => {
      const arg = { id: 21119 };
    ...
    it('dispatches UPDATE_MEDICINE actions', async () => {
      const arg = { id: 21119 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICINE actions', async () => {
      const arg = 42666;
