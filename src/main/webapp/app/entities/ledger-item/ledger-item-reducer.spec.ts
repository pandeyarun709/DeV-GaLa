...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEDGERITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEDGERITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEDGERITEM actions', async () => {
      const arg = { id: 6550 };
    ...
    it('dispatches UPDATE_LEDGERITEM actions', async () => {
      const arg = { id: 6550 };
    ...
    it('dispatches PARTIAL_UPDATE_LEDGERITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEDGERITEM actions', async () => {
      const arg = 42666;
