...
import reducer, {
  ...
  reset,
  updateEntity,
} from './patient-registration-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTREGISTRATIONDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PATIENTREGISTRATIONDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PATIENTREGISTRATIONDETAILS actions', async () => {
      const arg = { id: 11281 };
    ...
    it('dispatches UPDATE_PATIENTREGISTRATIONDETAILS actions', async () => {
      const arg = { id: 11281 };
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTREGISTRATIONDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PATIENTREGISTRATIONDETAILS actions', async () => {
      const arg = 42666;
