...
export const PrescriptionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hospitalBeApp.prescription.delete.question">
        <Translate contentKey="hospitalBeApp.prescription.delete.question" interpolate={{ id: prescriptionEntity.id }}>
