...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IPrescription, thunkAPI) => {
    return axios.post<IPrescription>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IPrescription, thunkAPI) => {
    return axios.put<IPrescription>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IPrescription, thunkAPI) => {
    return axios.patch<IPrescription>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IPrescription>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
