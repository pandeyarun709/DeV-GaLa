...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './slot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SLOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SLOT actions', async () => {
      const arg = { id: 17390 };
    ...
    it('dispatches UPDATE_SLOT actions', async () => {
      const arg = { id: 17390 };
    ...
    it('dispatches PARTIAL_UPDATE_SLOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SLOT actions', async () => {
      const arg = 42666;
