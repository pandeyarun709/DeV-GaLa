...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICINEDOSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICINEDOSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICINEDOSE actions', async () => {
      const arg = { id: 29938 };
    ...
    it('dispatches UPDATE_MEDICINEDOSE actions', async () => {
      const arg = { id: 29938 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICINEDOSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICINEDOSE actions', async () => {
      const arg = 42666;
