...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFERRALDOCTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REFERRALDOCTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REFERRALDOCTOR actions', async () => {
      const arg = { id: 30318 };
    ...
    it('dispatches UPDATE_REFERRALDOCTOR actions', async () => {
      const arg = { id: 30318 };
    ...
    it('dispatches PARTIAL_UPDATE_REFERRALDOCTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REFERRALDOCTOR actions', async () => {
      const arg = 42666;
